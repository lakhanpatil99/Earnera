  ...
  return (
    <div className="mobile-container bg-neutral-50 pb-24">
      <div className="px-6 pt-12 pb-8 bg-white shadow-sm border-b border-gray-100 rounded-b-[32px]">
        <h1 className="text-2xl font-extrabold text-gray-800 mb-8">Profile</h1>
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <div className="mt-2 inline-flex items-center px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[10px] font-bold uppercase tracking-wide border border-emerald-100">
              Verified User
            </div>
          </div>
        </div>
